...
\fancybreak{* * *}
\footnotesize
\booktitle{The American Eclectic Practice of Medicine}. By I.~G.\ \textsc{Jones}, M.~D., late Professor of the
...
\SectionStartWords{If} physicians will admit as true the statement of \textsc{Grotius} that ``The
...
\fancybreak{* * *}
\footnotesize
\booktitle{The Half-Yearly Abstract of the Medical Sciences}, etc.\ etc., edited by \textsc{W.~H.\ Ranking, M.~D.}
...
\SectionStartWords{The} reprint of this work, by the Messrs.\ \textsc{Wood}, always comes
