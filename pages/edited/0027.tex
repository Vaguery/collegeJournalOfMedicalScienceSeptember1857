\oldpage{411}of this city has extended I consider the charge a base slander, but as I
...
\booktitle{Observer} to rest upon the profession, I expressed my full conviction
...
But hardly had the ink become dry on the pages of the \ThisJournal{Journal}, ere
...
Dr.\ \ProperName{Cleaveland}.---\emph{Sir}.---As you are fully aware---the allusion to
Dr.\ Bauer, in your article on ``\emph{Abortion}'' in the Aug.\ No.\ of the
\ThisJournal{College Journal} is grossly and inexcusably false; and the personal
reference to his friends here are as intensely malicious---as unwarranted;---the
``\booktitle{Observer}'' therefore declines further exchange.

\hfill{}\ProperName{Edward~B.\ Stevens.}''\quad
...
publisher of the ``\booktitle{Observer}'' must now have as much internal as
...
I shall leave the readers of the \ThisJournal{Journal} to decide if the terms ``\emph{false}''
and ``\emph{malicious}'' do not rather belong to those who publish the ``\booktitle{Observer},''
...
the \booktitle{Observer}, or the former Faculty of the Miami Medical College.
Neither have I allowed the use of the \ThisJournal{Journal} of which I am publisher
or any other to do the same. Both the \ThisJournal{College Journal} and
