...
System, comprising a Materia Medica, with numerous Illustrations, By \ProperName{J.~Kost}, M.~D., etc., etc., etc. Cincinnati, R.~Wilson, 1857.
\plainbreak{1}
\normalsize

\SectionStartWords{From} the date upon the title page one would naturally suppose this
...
\ProperName{William Paine}, M.~D., Professor of the Principles and Practice of Medicine and Pathology
in the Eclectic Medical College of Pennsylvania. Philadelphia, \ProperName{H.~Cowperthwait}
and Co. 1857.
\plainbreak{1}
\normalsize

\SectionStartWords{From} the many subjects embraced in this title-page we might naturally
